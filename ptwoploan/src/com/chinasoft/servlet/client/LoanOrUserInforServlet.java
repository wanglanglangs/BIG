...
@WebServlet("/LoanOrUserInforServlet")
public class LoanOrUserInforServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public LoanOrUserInforServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		//System.out.println(uname+"222");
		if(uname==""||uname ==null)
		{
			response.sendRedirect("/ptwoploan/client/userinfor.jsp");
		}
		else{
			response.sendRedirect("/ptwoploan/client/loan.jsp");
		}
